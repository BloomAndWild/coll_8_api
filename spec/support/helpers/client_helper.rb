...
def configure_client(base_url: nil, client_id: nil, client_secret: nil, account: nil, token_endpoint: nil)
  Coll8Api::Client.configure do |config|
    ...
    config.token_endpoint =  token_endpoint || ENV.fetch('TOKEN_ENDPOINT')
